...
pgAdmin won't alert to FK, but we can have information via the
'constraints' element from the schema > table , just below the
'columns' element. Otherwise, right-click on the table, and go to
'Properties' > 'Constraints' tab, and select the 'Foreign Keys'
sub-tab to see the detailed relationships. Finally, a third way is
to look ath the 'Dependents' while selection a particular column
in the table.*/
